...
capture("text-mixed")
new_board("multiline-text")
ui("multiline-insert", 'click menu item "Text Box" of menu "Insert" of menu bar item "Insert" of menu bar 1\ndelay 0.5\nkeystroke "First "\nkeystroke "b" using command down\nkeystroke "Bold"\nkey code 36\nkeystroke "i" using command down\nkeystroke "Both"\nkey code 53\ndelay 0.5')
capture("text-multiline-combined")
ui("text-enlarge", 'keystroke "." using {command down, shift down}\ndelay 0.5')
capture("text-size-change")
