...
| Pressure-sensitive / erased ink      | **Genuine Freeform eraser and pressure-sensitive round trips remain unverified.** Apple framework fixtures are not Freeform captures. [#13](https://github.com/royalpinto007/boardeject/issues/13).                                                                                                                                                                                                                                                                               |
